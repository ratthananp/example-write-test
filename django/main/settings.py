...
if DEBUG:
    authentication_classes += (
        # Session Authentication use for Web browsable API that only enable when debugging
        'rest_framework.authentication.SessionAuthentication',
        # Usually Basic Authentication not have any use case for production environment, then it should enable when debugging
        'rest_framework.authentication.BasicAuthentication',
    )
    renderer_classes += (
        # Usually Web browsable API not have any use case for production environment, then it should enable when debugging
